...
export const messageRouter = () => {
  const messageRoutes = genericRoutes(
    Message,
    Message,
    MessageDto as unknown as ClassConstructor<Partial<Message>>, // Conversión para compatibilidad
    MessageSchema
  );
  ...
  messageRoutes.get(
    ...
    (req, res) =>
      /* 
      #swagger.path = '/messages/getAllWithMenu'
      #swagger.tags = ['Message']
      #swagger.description = 'Esta ruta trae todos los mensajes cuyo option es "MENU" junto con sus submensajes (hasta 3 niveles de hijos).'
      #swagger.security = [{ "bearerAuth": [] }]
      */
      messageController.getMessagesWithMenuMessages(req, res)
  );
  ...
  messageRoutes.get(
    ...
    (req, res) =>
      /* 
      #swagger.path = '/messages/getOneWithMenu/{id}'
      #swagger.tags = ['Message']
      #swagger.description = 'Esta ruta trae un mensaje específico con su submensajes hasta 3 niveles, donde el mensaje padre tiene option == "MENU".'
      #swagger.security = [{ "bearerAuth": [] }]
      ...
      */
      messageController.getOneWithMenuMessages(req, res)
  );
